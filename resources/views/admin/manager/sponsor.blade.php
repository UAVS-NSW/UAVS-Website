                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label control-label">Link Info</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control data-infor" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label control-label">Link Carrer</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control data-carrers" placeholder="">
                                            </div>
                                        </div>
                                    </div> 
                                </div>
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/sponsor.js') }}"></script>
