                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <textarea name="" class="form-control data-description" id="" rows="4"></textarea> 
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label control-label">Link liên kết</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <select name="" id="" class="form-control data-type">
                                                    <option value="1">UAVS Event</option>
                                                    <option value="2">Student Event</option>
                                                </select> 
                                            </div>
                                        </div> 
                                    </div> 
